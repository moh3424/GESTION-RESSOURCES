...
<head>
	...
	<title>GESTION DE SALARIES</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <!-- La marque -->
       <a class = "navbar-brand" href="<?php echo RACINE_SITE . 'connexion.php'; ?>">GESTION DE SALARIES</a>
        ...
        <div class="collapse navbar-collapse" id="nav1">
        	<ul class="navbar-nav ml-auto">
                ...
                if (internauteEstConnecteEtAdmin()){
                  echo '<li><a class="nav-link" href = "' . RACINE_SITE . 'admin/gestion_salarie.php">Gestion des salariés</a></li>';
                  echo '<li><a class="nav-link" href = "' . RACINE_SITE . 'admin/gestion_salarie.php?action=deconnexion">Se déconnecter</a></li>';
                }
